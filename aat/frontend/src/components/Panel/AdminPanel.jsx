...
//testimonials
 ...
 const [testimonials, setTestimonials] = useState([]);
  ...
  // ✅ Handlers
  const handletestimonialAddClick = () => setShowAddForm(true);

  const handletestimonialAddSubmit = async (data) => {
    const res = await axios.post("http://localhost:4001/api/testimonials", data);
    setTestimonials([res.data, ...testimonials]);
    setShowAddForm(false);
  };

  const handletestimonialEditClick = (testimonial) => {
    setEditingTestimonial(testimonial);
    setShowEditForm(true);
  };

  const handleEditestimonialtSubmit = async (data) => {
  ...
  // Duplicate handletestimonialDelete removed
...
// ✅ Testimonial Handler for delete
